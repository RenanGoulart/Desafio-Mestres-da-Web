...
const comicsList = [
  {
    name: 'Thor: Vikings',
    about: 'Garth Ennis e sua violência atacam novamente na HQ que leva a violência das histórias de Thor ao limite! Na minissérie de 2003 vemos vikings de um passado distante voltando a vida.',
  ...
  },
  {
    ...
    about: 'O único oponente do Devorador de Mundos é o herói que ele aprisionou na Terra: o Surfista Prateado, Galactus jurou não consumir o planeta, mas e se, em vez disso, ele transformar a civilização em seus adoradores?',
    availableIn: [americanasUrl, amazonUrl],
    rating: 4,
...
export const Comics = () => {
  return (
    <>
      <Head title='Marvel | HQS' description='HQS da marvel' />
      <Header />
      <ComicsContainer>
