...
const moviesList = [
  {
    name: 'Homem de Ferro',
    about: 'Tony Stark (Robert Downey Jr.) é um industrial bilionário, que também é um brilhante inventor, ao ser sequestrado, ele é obrigado a construir uma arma devastadora, mas ao invés disso, cria uma armadura capaz de mudar a história.',
  ...
  },
  {
    ...
    about: 'O mundo já sabe que o inventor bilionário Tony Stark (Robert Downey Jr.) é o super-herói blindado Homem de Ferro. Sofrendo pressão do governo, da mídia e do público para compartilhar sua tecnologia com as forças armadas',
    availableIn: [disneyUrl],
    rating: 4,
    image: ironman2Url,
    chronology: 4,
...
export const Movies = () => {
  ...
  return (
    <>
      <Head title='Marvel | Filmes' description='Filmes da Marvel' />
      <Header />
      <MoviesContainer>
        <Filter open={open}>
          ...
          <Option open={open} onClick={() => {setSelected('Lançamento'); setOpen(!open)}}>
            Lançamento
          </Option>
          <Option open={open} onClick={() => {setSelected('Cronologia'); setOpen(!open)}}>
            Cronologia
          </Option>
        </Filter>
